...
const WeaponList = () => {
  const [weapons, setWeapons] = useState([
    { name: "ZTA", quantity: "", points: "", weight: "" },
    { name: "ZPT", quantity: "", points: "", weight: "" },
    { name: "FN MAG", quantity: "", points: "", weight: "" },
    { name: "M240", quantity: "", points: "", weight: "" },
    { name: "Uçak Savar", quantity: "", points: "", weight: "" },
